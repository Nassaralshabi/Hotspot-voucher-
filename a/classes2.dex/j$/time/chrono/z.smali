...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v4, v3, v5}, Lj$/time/chrono/z;-><init>(ILj$/time/h;Ljava/lang/String;)V
    ...
    invoke-direct {v3, v2, v5, v6}, Lj$/time/chrono/z;-><init>(ILj$/time/h;Ljava/lang/String;)V
    ...
    invoke-direct {v5, v7, v6, v8}, Lj$/time/chrono/z;-><init>(ILj$/time/h;Ljava/lang/String;)V
    ...
    invoke-direct {v6, v10, v8, v11}, Lj$/time/chrono/z;-><init>(ILj$/time/h;Ljava/lang/String;)V
...
.method public static A()[Lj$/time/chrono/z;
    .locals 2
...
.method static h(Lj$/time/h;)Lj$/time/chrono/z;
    .locals 4
    ...
    iget-object v3, v2, Lj$/time/chrono/z;->b:Lj$/time/h;

    invoke-virtual {p0, v3}, Lj$/time/h;->O(Lj$/time/chrono/b;)I
...
.method static i()Lj$/time/chrono/z;
    .locals 2
...
.method static w()J
    ...
    invoke-virtual {v0}, Lj$/time/temporal/a;->p()Lj$/time/temporal/s;
    ...
    invoke-virtual {v7}, Lj$/time/h;->X()I
    ...
    invoke-virtual {v5}, Lj$/time/h;->X()I
...
.method static z()J
    ...
    iget-object v0, v5, Lj$/time/chrono/z;->b:Lj$/time/h;
...
.method final n()Lj$/time/h;
    ...
    iget-object v0, p0, Lj$/time/chrono/z;->b:Lj$/time/h;
...
.method public final u(Lj$/time/temporal/p;)Lj$/time/temporal/s;
    ...
    invoke-virtual {p1, v0}, Lj$/time/chrono/w;->J(Lj$/time/temporal/a;)Lj$/time/temporal/s;
