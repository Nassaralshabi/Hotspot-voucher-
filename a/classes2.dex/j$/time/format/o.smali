...
.method public final p(Lj$/time/format/t;Ljava/lang/StringBuilder;)Z
    ...
    invoke-virtual {p1, v0}, Lj$/time/format/t;->e(Lj$/time/temporal/p;)Ljava/lang/Long;
    ...
    invoke-interface {v1, v2}, Lj$/time/temporal/TemporalAccessor;->C(Lj$/time/temporal/q;)Ljava/lang/Object;
    ...
    iget-object v7, p0, Lj$/time/format/o;->b:Lj$/time/format/A;
    ...
    invoke-virtual/range {v2 .. v8}, Lj$/time/format/b;->b(Lj$/time/chrono/m;Lj$/time/temporal/p;JLj$/time/format/A;Ljava/util/Locale;)Ljava/lang/String;
    ...
    iget-object v5, p0, Lj$/time/format/o;->b:Lj$/time/format/A;
    ...
    invoke-virtual/range {v1 .. v6}, Lj$/time/format/b;->c(Lj$/time/temporal/p;JLj$/time/format/A;Ljava/util/Locale;)Ljava/lang/String;
    ...
    invoke-direct {v0, v2, v1, v3, v4}, Lj$/time/format/i;-><init>(Lj$/time/temporal/p;IILj$/time/format/z;)V
...
.method public final r(Lj$/time/format/q;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v2, v1, v3, v0, v4}, Lj$/time/format/b;->d(Lj$/time/chrono/m;Lj$/time/temporal/p;Lj$/time/format/A;Ljava/util/Locale;)Ljava/util/Iterator;
    ...
    invoke-virtual {v2, v3, v0, v4}, Lj$/time/format/b;->e(Lj$/time/temporal/p;Lj$/time/format/A;Ljava/util/Locale;)Ljava/util/Iterator;
    ...
    iget-object v6, p0, Lj$/time/format/o;->a:Lj$/time/temporal/p;
    ...
    invoke-direct {v0, v1, v3, v4, v2}, Lj$/time/format/i;-><init>(Lj$/time/temporal/p;IILj$/time/format/z;)V
