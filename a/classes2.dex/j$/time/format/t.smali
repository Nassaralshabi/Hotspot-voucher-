...
.method constructor <init>(Lj$/time/temporal/TemporalAccessor;Lj$/time/format/DateTimeFormatter;)V
    ...
    invoke-interface {p1, v3}, Lj$/time/temporal/TemporalAccessor;->C(Lj$/time/temporal/q;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v6}, Lj$/time/temporal/TemporalAccessor;->g(Lj$/time/temporal/p;)Z
    ...
    invoke-interface {p1, v6}, Lj$/time/temporal/TemporalAccessor;->r(Lj$/time/temporal/p;)I
    ...
    invoke-interface {p1, v1}, Lj$/time/temporal/TemporalAccessor;->g(Lj$/time/temporal/p;)Z

    move-result v1

    if-eqz v1, :cond_b

    invoke-interface {v4, p1}, Lj$/time/chrono/m;->s(Lj$/time/temporal/TemporalAccessor;)Lj$/time/chrono/b;
    ...
    invoke-virtual {v7}, Lj$/time/temporal/a;->E()Z

    move-result v8

    if-eqz v8, :cond_e

    invoke-interface {p1, v7}, Lj$/time/temporal/TemporalAccessor;->g(Lj$/time/temporal/p;)Z
    ...
    invoke-direct {v0, v5, p1, v4, v3}, Lj$/time/format/s;-><init>(Lj$/time/chrono/b;Lj$/time/temporal/TemporalAccessor;Lj$/time/chrono/m;Lj$/time/ZoneId;)V
...
.method final e(Lj$/time/temporal/p;)Ljava/lang/Long;
    ...
    invoke-interface {v1, p1}, Lj$/time/temporal/TemporalAccessor;->g(Lj$/time/temporal/p;)Z
    ...
    :cond_0
    invoke-interface {v1, p1}, Lj$/time/temporal/TemporalAccessor;->x(Lj$/time/temporal/p;)J
