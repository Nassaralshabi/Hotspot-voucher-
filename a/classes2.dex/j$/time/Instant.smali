...
.method public static S(Lj$/time/temporal/TemporalAccessor;)Lj$/time/Instant;
    ...
    invoke-interface {p0, v2}, Lj$/time/temporal/TemporalAccessor;->r(Lj$/time/temporal/p;)I
...
.method private a0(Lj$/time/Instant;)J
    .locals 9
...
.method public final f(Lj$/time/temporal/Temporal;Lj$/time/temporal/TemporalUnit;)J
    ...
    :pswitch_0
    invoke-direct {p0, p1}, Lj$/time/Instant;->a0(Lj$/time/Instant;)J
    ...
    invoke-static {v6, v7, v4, v5}, Lj$/com/android/tools/r8/a;->m(JJ)J

    move-result-wide v4

    invoke-static {v4, v5, v2, v3}, Lj$/com/android/tools/r8/a;->l(JJ)J
...
.method public toEpochMilli()J
    ...
    invoke-static {v2, v3, v0, v1}, Lj$/com/android/tools/r8/a;->f(JJ)J
...
.method public truncatedTo(Lj$/time/temporal/TemporalUnit;)Lj$/time/Instant;
    ...
    :cond_0
    invoke-interface {p1}, Lj$/time/temporal/TemporalUnit;->r()Lj$/time/e;
    ...
    invoke-static {v4, v5, v0, v1}, Lj$/com/android/tools/r8/a;->k(JJ)J
    ...
    invoke-direct {p0, v6, v7, v2, v3}, Lj$/time/Instant;->Y(JJ)Lj$/time/Instant;
