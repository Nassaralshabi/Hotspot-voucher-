...
.method constructor <init>(Lj$/util/stream/b;Lj$/util/stream/b;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)V
    ...
    invoke-virtual {p1, p2}, Lj$/util/stream/d3;->u(I)Z
...
.method protected final a()Ljava/lang/Object;
    ...
    iget-boolean v2, p0, Lj$/util/stream/e4;->j:Z

    if-eqz v2, :cond_0

    sget-object v2, Lj$/util/stream/d3;->SIZED:Lj$/util/stream/d3;

    iget-object v3, p0, Lj$/util/stream/e4;->h:Lj$/util/stream/b;

    iget v3, v3, Lj$/util/stream/b;->c:I

    invoke-virtual {v2, v3}, Lj$/util/stream/d3;->x(I)Z
    ...
    invoke-virtual {v2, v3}, Lj$/util/stream/b;->G(Lj$/util/Spliterator;)J
    ...
    iget-object v5, p0, Lj$/util/stream/e4;->i:Ljava/util/function/IntFunction;

    invoke-virtual {v4, v2, v3, v5}, Lj$/util/stream/b;->N(JLjava/util/function/IntFunction;)Lj$/util/stream/B0;
    ...
    iget-boolean v4, p0, Lj$/util/stream/e4;->j:Z
    ...
    :goto_1
    invoke-interface {v3, v2, v1}, Lj$/util/stream/c4;->k(Lj$/util/stream/B0;Z)Lj$/util/stream/d4;
    ...
    invoke-virtual {v1, v3, v0}, Lj$/util/stream/b;->V(Lj$/util/Spliterator;Lj$/util/stream/p2;)Lj$/util/stream/p2;

    invoke-interface {v2}, Lj$/util/stream/B0;->a()Lj$/util/stream/J0;
...
.method public final onCompletion(Ljava/util/concurrent/CountedCompleter;)V
    ...
    invoke-static {v0, v1, v2}, Lj$/util/stream/x0;->I(Lj$/util/stream/e3;Lj$/util/stream/J0;Lj$/util/stream/J0;)Lj$/util/stream/L0;
    ...
    invoke-interface/range {v1 .. v6}, Lj$/util/stream/J0;->h(JJLjava/util/function/IntFunction;)Lj$/util/stream/J0;
