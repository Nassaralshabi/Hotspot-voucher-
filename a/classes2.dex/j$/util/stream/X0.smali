...
# static fields
.field private static final a:Lj$/util/stream/c1;

.field private static final b:Lj$/util/stream/F0;

.field private static final c:Lj$/util/stream/H0;

.field private static final d:Lj$/util/stream/D0;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lj$/util/stream/x0;->a:Lj$/util/stream/c1;

    new-instance v0, Lj$/util/stream/a1;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lj$/util/stream/x0;->b:Lj$/util/stream/F0;

    new-instance v0, Lj$/util/stream/b1;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lj$/util/stream/x0;->c:Lj$/util/stream/H0;

    new-instance v0, Lj$/util/stream/Z0;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lj$/util/stream/x0;->d:Lj$/util/stream/D0;
...
.method static C(Lj$/util/stream/e3;Lj$/util/Spliterator;JJ)Lj$/util/Spliterator;
    ...
    invoke-direct/range {v5 .. v10}, Lj$/util/stream/w3;-><init>(Lj$/util/f0;JJ)V
...
.method static D(JLjava/util/function/IntFunction;)Lj$/util/stream/B0;
    .locals 2
    ...
    invoke-direct {v0, p0, p1, p2}, Lj$/util/stream/M0;-><init>(JLjava/util/function/IntFunction;)V
...
.method public static E(Lj$/util/stream/b;Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/J0;
    .locals 7
    ...
    invoke-direct {p3, p1, p0, p2}, Lj$/util/stream/u1;-><init>(Lj$/util/Spliterator;Lj$/util/stream/b;[Ljava/lang/Object;)V
    ...
    iput-object p3, v3, Lj$/util/stream/P0;->a:Ljava/util/function/IntFunction;
    ...
    invoke-direct/range {v0 .. v5}, Lj$/util/stream/O0;-><init>(Lj$/util/stream/b;Lj$/util/Spliterator;Ljava/util/function/LongFunction;Ljava/util/function/BinaryOperator;I)V
    ...
    invoke-static {p0, p3}, Lj$/util/stream/x0;->N(Lj$/util/stream/J0;Ljava/util/function/IntFunction;)Lj$/util/stream/J0;
...
.method public static F(Lj$/util/stream/b;Lj$/util/Spliterator;Z)Lj$/util/stream/D0;
    .locals 7
    ...
    invoke-direct {v0, p1, p0, p2}, Lj$/util/stream/r1;-><init>(Lj$/util/Spliterator;Lj$/util/stream/b;[D)V

    invoke-virtual {v0}, Ljava/util/concurrent/ForkJoinTask;->invoke()Ljava/lang/Object;

    new-instance p0, Lj$/util/stream/W0;

    invoke-direct {p0, p2}, Lj$/util/stream/W0;-><init>([D)V
    ...
    invoke-static {p0}, Lj$/util/stream/x0;->O(Lj$/util/stream/D0;)Lj$/util/stream/D0;
...
.method public static G(Lj$/util/stream/b;Lj$/util/Spliterator;Z)Lj$/util/stream/F0;
    .locals 7
    ...
    invoke-direct {v0, p1, p0, p2}, Lj$/util/stream/s1;-><init>(Lj$/util/Spliterator;Lj$/util/stream/b;[I)V

    invoke-virtual {v0}, Ljava/util/concurrent/ForkJoinTask;->invoke()Ljava/lang/Object;

    new-instance p0, Lj$/util/stream/f1;

    invoke-direct {p0, p2}, Lj$/util/stream/f1;-><init>([I)V
    ...
    invoke-static {p0}, Lj$/util/stream/x0;->P(Lj$/util/stream/F0;)Lj$/util/stream/F0;
...
.method public static H(Lj$/util/stream/b;Lj$/util/Spliterator;Z)Lj$/util/stream/H0;
    .locals 7
    ...
    invoke-direct {v0, p1, p0, p2}, Lj$/util/stream/t1;-><init>(Lj$/util/Spliterator;Lj$/util/stream/b;[J)V

    invoke-virtual {v0}, Ljava/util/concurrent/ForkJoinTask;->invoke()Ljava/lang/Object;

    new-instance p0, Lj$/util/stream/o1;

    invoke-direct {p0, p2}, Lj$/util/stream/o1;-><init>([J)V
    ...
    invoke-static {p0}, Lj$/util/stream/x0;->Q(Lj$/util/stream/H0;)Lj$/util/stream/H0;
...
.method static I(Lj$/util/stream/e3;Lj$/util/stream/J0;Lj$/util/stream/J0;)Lj$/util/stream/L0;
    .locals 2
...
.method static J(J)Lj$/util/stream/y0;
    .locals 2
...
.method public static K(Lj$/util/W;)Lj$/util/stream/E;
    .locals 3

    new-instance v0, Lj$/util/stream/z;

    invoke-static {p0}, Lj$/util/stream/d3;->t(Lj$/util/Spliterator;)I
...
.method static L(Lj$/util/stream/e3;)Lj$/util/stream/d1;
    .locals 3
    ...
    sget-object p0, Lj$/util/stream/x0;->d:Lj$/util/stream/D0;
    ...
    :cond_1
    sget-object p0, Lj$/util/stream/x0;->c:Lj$/util/stream/H0;

    goto :goto_0

    :cond_2
    sget-object p0, Lj$/util/stream/x0;->b:Lj$/util/stream/F0;

    goto :goto_0

    :cond_3
    sget-object p0, Lj$/util/stream/x0;->a:Lj$/util/stream/c1;
...
.method public static N(Lj$/util/stream/J0;Ljava/util/function/IntFunction;)Lj$/util/stream/J0;
    .locals 4

    invoke-interface {p0}, Lj$/util/stream/J0;->q()I
    ...
    invoke-direct {v0, p0, p1, v1}, Lj$/util/stream/y1;-><init>(Lj$/util/stream/J0;Ljava/lang/Object;I)V
...
.method public static O(Lj$/util/stream/D0;)Lj$/util/stream/D0;
    .locals 4
    ...
    invoke-direct {v1, p0, v0, v2}, Lj$/util/stream/y1;-><init>(Lj$/util/stream/J0;Ljava/lang/Object;I)V

    invoke-virtual {v1}, Ljava/util/concurrent/ForkJoinTask;->invoke()Ljava/lang/Object;

    new-instance p0, Lj$/util/stream/W0;

    invoke-direct {p0, v0}, Lj$/util/stream/W0;-><init>([D)V
...
.method public static P(Lj$/util/stream/F0;)Lj$/util/stream/F0;
    .locals 4
    ...
    invoke-direct {p0, v0}, Lj$/util/stream/f1;-><init>([I)V
...
.method public static Q(Lj$/util/stream/H0;)Lj$/util/stream/H0;
    .locals 4
    ...
    invoke-direct {p0, v0}, Lj$/util/stream/o1;-><init>([J)V
...
.method static S(J)Lj$/util/stream/z0;
    .locals 2
...
.method static U(J)Lj$/util/stream/A0;
    .locals 2
...
.method public static V(Lj$/util/c0;)Lj$/util/stream/m0;
    .locals 3
...
.method public static W(Lj$/util/stream/b;JJ)Lj$/util/stream/E;
    ...
    invoke-static {p3, p4}, Lj$/util/stream/x0;->M(J)I
    ...
    invoke-direct/range {v1 .. v7}, Lj$/util/stream/x2;-><init>(Lj$/util/stream/b;IJJ)V
...
.method public static X(Lj$/util/stream/u0;)Lj$/util/stream/v0;
    .locals 4
    ...
    invoke-direct {v2, p0, v3}, Lj$/util/stream/n0;-><init>(Lj$/util/stream/u0;I)V

    invoke-direct {v0, v1, p0, v2}, Lj$/util/stream/v0;-><init>(Lj$/util/stream/e3;Lj$/util/stream/u0;Ljava/util/function/Supplier;)V
...
.method public static Y(Lj$/util/stream/b;JJ)Lj$/util/stream/IntStream;
    ...
    invoke-direct/range {v1 .. v7}, Lj$/util/stream/t2;-><init>(Lj$/util/stream/b;IJJ)V
...
.method public static Z(Lj$/util/stream/u0;)Lj$/util/stream/v0;
    .locals 4
...
.method public static a0(Lj$/util/stream/b;JJ)Lj$/util/stream/m0;
    .locals 8
    ...
    invoke-direct/range {v1 .. v7}, Lj$/util/stream/v2;-><init>(Lj$/util/stream/b;IJJ)V
...
.method public static b0(Lj$/util/stream/u0;)Lj$/util/stream/v0;
    .locals 4
...
.method public static c0(Lj$/util/stream/u0;Ljava/util/function/Predicate;)Lj$/util/stream/v0;
    .locals 4
    ...
    invoke-direct {v2, v3, p0, p1}, Lj$/util/stream/o0;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public static d0(Lj$/util/stream/b;JJ)Lj$/util/stream/Stream;
    ...
    invoke-direct/range {v1 .. v7}, Lj$/util/stream/r2;-><init>(Lj$/util/stream/b;IJJ)V
...
.method public static m(Lj$/util/stream/I0;Ljava/util/function/IntFunction;)[Ljava/lang/Object;
    .locals 4
    ...
    invoke-interface {p0, p1, v0}, Lj$/util/stream/J0;->i([Ljava/lang/Object;I)V
...
.method public static n(Lj$/util/stream/D0;[Ljava/lang/Double;I)V
    .locals 4
    ...
    invoke-interface {p0}, Lj$/util/stream/I0;->d()Ljava/lang/Object;
...
.method public static o(Lj$/util/stream/F0;[Ljava/lang/Integer;I)V
    .locals 3
...
.method public static p(Lj$/util/stream/H0;[Ljava/lang/Long;I)V
    .locals 4
...
.method public static q(Lj$/util/stream/D0;Ljava/util/function/Consumer;)V
    .locals 1
    ...
    invoke-interface {p0, p1}, Lj$/util/stream/I0;->e(Ljava/lang/Object;)V
    ...
    invoke-interface {p0}, Lj$/util/stream/I0;->spliterator()Lj$/util/f0;
...
.method public static r(Lj$/util/stream/F0;Ljava/util/function/Consumer;)V
    .locals 1
...
.method public static s(Lj$/util/stream/H0;Ljava/util/function/Consumer;)V
    .locals 1
...
.method public static t(Lj$/util/stream/D0;JJ)Lj$/util/stream/D0;
    .locals 8
    ...
    invoke-static {v0, v1}, Lj$/util/stream/x0;->J(J)Lj$/util/stream/y0;
    ...
    invoke-direct {v6, v7}, Lj$/util/stream/C0;-><init>(I)V
    ...
    invoke-interface {v3}, Lj$/util/stream/y0;->a()Lj$/util/stream/D0;
...
.method public static u(Lj$/util/stream/F0;JJ)Lj$/util/stream/F0;
    .locals 8
    ...
    invoke-static {v0, v1}, Lj$/util/stream/x0;->S(J)Lj$/util/stream/z0;
    ...
    invoke-interface {v3}, Lj$/util/stream/z0;->a()Lj$/util/stream/F0;
...
.method public static v(Lj$/util/stream/H0;JJ)Lj$/util/stream/H0;
    .locals 8
    ...
    invoke-static {v0, v1}, Lj$/util/stream/x0;->U(J)Lj$/util/stream/A0;
    ...
    invoke-interface {v3}, Lj$/util/stream/A0;->a()Lj$/util/stream/H0;
...
.method public static w(Lj$/util/stream/J0;JJLjava/util/function/IntFunction;)Lj$/util/stream/J0;
    .locals 7
    ...
    invoke-static {v1, v2, p5}, Lj$/util/stream/x0;->D(JLjava/util/function/IntFunction;)Lj$/util/stream/B0;
    ...
    invoke-interface {p5}, Lj$/util/stream/B0;->a()Lj$/util/stream/J0;
...
.method public b(Lj$/util/stream/b;Lj$/util/Spliterator;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lj$/util/stream/x0;->e0()Lj$/util/stream/T1;
...
.method public c(Lj$/util/stream/b;Lj$/util/Spliterator;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p1, p2}, Lj$/util/stream/a2;-><init>(Lj$/util/stream/x0;Lj$/util/stream/b;Lj$/util/Spliterator;)V
...
.method public abstract e0()Lj$/util/stream/T1;
.end method
