...
.method constructor <init>(Lj$/util/stream/b;I)V
    ...
    invoke-static {p2, v1}, Lj$/util/stream/d3;->p(II)I
...
.method private S(I)Lj$/util/Spliterator;
    ...
    invoke-virtual {v3, v4}, Lj$/util/stream/d3;->u(I)Z
    ...
    invoke-static {v4, v0}, Lj$/util/stream/d3;->p(II)I
    ...
    invoke-static {p1, v0}, Lj$/util/stream/d3;->p(II)I
...
.method final A(Lj$/util/Spliterator;Lj$/util/stream/p2;)V
    ...
    invoke-virtual {v0, v1}, Lj$/util/stream/d3;->u(I)Z
...
.method final C(Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/J0;
    .locals 2
    ...
    invoke-virtual {p0, p0, p1, p2, p3}, Lj$/util/stream/b;->F(Lj$/util/stream/b;Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/J0;
    ...
    invoke-virtual {p0, v0, v1, p3}, Lj$/util/stream/b;->N(JLjava/util/function/IntFunction;)Lj$/util/stream/B0;

    move-result-object p2

    invoke-virtual {p0, p1, p2}, Lj$/util/stream/b;->V(Lj$/util/Spliterator;Lj$/util/stream/p2;)Lj$/util/stream/p2;

    invoke-interface {p2}, Lj$/util/stream/B0;->a()Lj$/util/stream/J0;
...
.method final E(Ljava/util/function/IntFunction;)Lj$/util/stream/J0;
    .locals 4
    ...
    invoke-virtual {p0, v1, v0, p1}, Lj$/util/stream/b;->O(Lj$/util/stream/b;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/J0;
    ...
    invoke-virtual {p0, v1, v0, p1}, Lj$/util/stream/b;->C(Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/J0;
...
.method abstract F(Lj$/util/stream/b;Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/J0;
.end method
...
.method abstract N(JLjava/util/function/IntFunction;)Lj$/util/stream/B0;
.end method

.method O(Lj$/util/stream/b;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/J0;
    .locals 0
...
.method P(Lj$/util/stream/b;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lj$/util/stream/b;->O(Lj$/util/stream/b;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/J0;
