...
.method public final synthetic asLongStream()Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->asLongStream()Lj$/util/stream/m0;

    move-result-object v0

    invoke-static {v0}, Lj$/util/stream/l0;->k(Lj$/util/stream/m0;)Ljava/util/stream/LongStream;
...
.method public final synthetic average()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->average()Lj$/util/C;
...
.method public final synthetic findAny()Ljava/util/OptionalInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->findAny()Lj$/util/D;

    move-result-object v0

    invoke-static {v0}, Lj$/util/d;->o(Lj$/util/D;)Ljava/util/OptionalInt;
...
.method public final synthetic findFirst()Ljava/util/OptionalInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->findFirst()Lj$/util/D;
...
.method public final flatMap(Ljava/util/function/IntFunction;)Ljava/util/stream/IntStream;
    ...
    iput-object p1, v1, Lj$/util/stream/P0;->a:Ljava/util/function/IntFunction;

    invoke-interface {v0, v1}, Lj$/util/stream/IntStream;->q(Lj$/util/stream/P0;)Lj$/util/stream/IntStream;
...
.method public final synthetic iterator()Ljava/util/PrimitiveIterator$OfInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->iterator()Lj$/util/M;

    move-result-object v0

    invoke-static {v0}, Lj$/util/L;->a(Lj$/util/M;)Ljava/util/PrimitiveIterator$OfInt;
...
.method public final synthetic mapToLong(Ljava/util/function/IntToLongFunction;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {p1}, Lj$/util/stream/IntStream;->m()Lj$/util/stream/m0;

    move-result-object p1

    invoke-static {p1}, Lj$/util/stream/l0;->k(Lj$/util/stream/m0;)Ljava/util/stream/LongStream;
...
.method public final synthetic max()Ljava/util/OptionalInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->max()Lj$/util/D;
...
.method public final synthetic min()Ljava/util/OptionalInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->min()Lj$/util/D;
...
.method public final synthetic reduce(Ljava/util/function/IntBinaryOperator;)Ljava/util/OptionalInt;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->reduce(Ljava/util/function/IntBinaryOperator;)Lj$/util/D;

    move-result-object p1

    invoke-static {p1}, Lj$/util/d;->o(Lj$/util/D;)Ljava/util/OptionalInt;
