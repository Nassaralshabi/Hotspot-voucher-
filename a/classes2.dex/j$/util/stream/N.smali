...
# direct methods
.method static Y(Lj$/util/stream/b;Lj$/util/Spliterator;)Lj$/util/stream/N0;
    .locals 7
    ...
    invoke-virtual {v6, p0, p1}, Lj$/util/stream/x0;->c(Lj$/util/stream/b;Lj$/util/Spliterator;)Ljava/lang/Object;
...
.method final O(Lj$/util/stream/b;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/J0;
    ...
    invoke-virtual {p1, p2, v1, p3}, Lj$/util/stream/b;->C(Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/J0;
    ...
    invoke-virtual {p3, v0}, Lj$/util/stream/d3;->u(I)Z

    move-result p3

    if-eqz p3, :cond_1

    invoke-static {p1, p2}, Lj$/util/stream/n;->Y(Lj$/util/stream/b;Lj$/util/Spliterator;)Lj$/util/stream/N0;
    ...
    invoke-direct {v2, v3, p3, v0}, Lj$/util/stream/o0;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method final R(ILj$/util/stream/p2;)Lj$/util/stream/p2;
    ...
    invoke-virtual {v0, p1}, Lj$/util/stream/d3;->u(I)Z
    ...
    invoke-direct {p1, p2}, Lj$/util/stream/l;-><init>(Lj$/util/stream/p2;)V
