...
.method constructor <init>(Lj$/util/Spliterator;Lj$/util/stream/b;I)V
    ...
    iput-object p2, p0, Lj$/util/stream/v1;->b:Lj$/util/stream/b;
...
.method constructor <init>(Lj$/util/stream/v1;Lj$/util/Spliterator;JJI)V
    .locals 2
    ...
    iget-object p2, p1, Lj$/util/stream/v1;->b:Lj$/util/stream/b;
...
.method abstract b(Lj$/util/Spliterator;JJ)Lj$/util/stream/v1;
.end method

.method public final compute()V
    .locals 10

    iget-object v6, p0, Lj$/util/stream/v1;->a:Lj$/util/Spliterator;
    ...
    iget-wide v2, v7, Lj$/util/stream/v1;->c:J
    ...
    iget-wide v2, v7, Lj$/util/stream/v1;->d:J

    move-object v0, v7

    move-wide v4, v8

    invoke-virtual/range {v0 .. v5}, Lj$/util/stream/v1;->b(Lj$/util/Spliterator;JJ)Lj$/util/stream/v1;

    move-result-object v0

    invoke-virtual {v0}, Ljava/util/concurrent/ForkJoinTask;->fork()Ljava/util/concurrent/ForkJoinTask;

    iget-wide v0, v7, Lj$/util/stream/v1;->d:J

    add-long v2, v0, v8

    iget-wide v0, v7, Lj$/util/stream/v1;->e:J
    ...
    :cond_0
    iget-object v0, v7, Lj$/util/stream/v1;->b:Lj$/util/stream/b;
