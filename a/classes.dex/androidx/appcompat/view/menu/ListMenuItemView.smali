...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {v0, p2, v1, v2, v3}, Lo3/e;->c0(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lo3/e;

    move-result-object p2

    const/4 v0, 0x5

    invoke-virtual {p2, v0}, Lo3/e;->O(I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p2, Lo3/e;->r:Ljava/lang/Object;
    ...
    iput v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->z:I
...
.method public final b(Lo/j;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->p:Lo/j;
    ...
    iget-object v0, p1, Lo/j;->e:Ljava/lang/CharSequence;

    invoke-virtual {p0, v0}, Landroidx/appcompat/view/menu/ListMenuItemView;->setTitle(Ljava/lang/CharSequence;)V

    invoke-virtual {p1}, Lo/j;->isCheckable()Z

    move-result v0

    invoke-virtual {p0, v0}, Landroidx/appcompat/view/menu/ListMenuItemView;->setCheckable(Z)V

    iget-object v0, p1, Lo/j;->n:Lo/i;
    ...
    iget-char v0, p1, Lo/j;->j:C

    goto :goto_1

    :cond_1
    iget-char v0, p1, Lo/j;->h:C
    ...
    :goto_2
    iget-object v4, p1, Lo/j;->n:Lo/i;

    invoke-virtual {v4}, Lo/i;->m()Z

    if-eqz v0, :cond_4

    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->p:Lo/j;

    iget-object v4, v0, Lo/j;->n:Lo/i;

    invoke-virtual {v4}, Lo/i;->n()Z
    ...
    iget-char v0, v0, Lo/j;->j:C

    goto :goto_3

    :cond_3
    iget-char v0, v0, Lo/j;->h:C
    ...
    iget-object v4, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->p:Lo/j;

    iget-object v5, v4, Lo/j;->n:Lo/i;

    invoke-virtual {v5}, Lo/i;->m()Z

    move-result v5

    if-eqz v5, :cond_5

    iget-char v5, v4, Lo/j;->j:C

    goto :goto_5

    :cond_5
    iget-char v5, v4, Lo/j;->h:C
    ...
    :cond_6
    iget-object v6, v4, Lo/j;->n:Lo/i;

    iget-object v7, v6, Lo/i;->a:Landroid/content/Context;
    ...
    iget-object v9, v6, Lo/i;->a:Landroid/content/Context;
    ...
    invoke-static {v8, v4, v9, v6}, Lo/j;->a(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    invoke-static {v8, v4, v3, v6}, Lo/j;->a(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    invoke-static {v8, v4, v6, v3}, Lo/j;->a(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    invoke-static {v8, v4, v1, v3}, Lo/j;->a(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    iget-object p1, p1, Lo/j;->q:Ljava/lang/CharSequence;
...
.method public setCheckable(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->p:Lo/j;

    invoke-virtual {p1}, Lo/j;->isChecked()Z
