...
.method public constructor <init>(Lcom/google/android/material/textfield/TextInputLayout;Lo3/e;)V
    ...
    iput-object p1, p0, LK2/v;->p:Lcom/google/android/material/textfield/TextInputLayout;
    ...
    iput-object v1, p0, LK2/v;->s:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    invoke-direct {v4, v5, v6}, Lp/G;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    iput-object v4, p0, LK2/v;->q:Lp/G;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v5

    invoke-static {v5}, LW1/g;->u(Landroid/content/Context;)Z
    ...
    :cond_0
    iget-object v5, p0, LK2/v;->x:Landroid/view/View$OnLongClickListener;

    invoke-virtual {v1, v6}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-static {v1, v5}, LU1/a;->M(Lcom/google/android/material/internal/CheckableImageButton;Landroid/view/View$OnLongClickListener;)V

    iput-object v6, p0, LK2/v;->x:Landroid/view/View$OnLongClickListener;

    invoke-virtual {v1, v6}, Landroid/view/View;->setOnLongClickListener(Landroid/view/View$OnLongClickListener;)V

    invoke-static {v1, v6}, LU1/a;->M(Lcom/google/android/material/internal/CheckableImageButton;Landroid/view/View$OnLongClickListener;)V

    iget-object v5, p2, Lo3/e;->r:Ljava/lang/Object;
    ...
    invoke-static {v8, p2, v7}, LW1/g;->o(Landroid/content/Context;Lo3/e;I)Landroid/content/res/ColorStateList;

    move-result-object v7

    iput-object v7, p0, LK2/v;->t:Landroid/content/res/ColorStateList;
    ...
    invoke-static {v7, v6}, LC2/m;->f(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v7

    iput-object v7, p0, LK2/v;->u:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {p2, v7}, Lo3/e;->O(I)Landroid/graphics/drawable/Drawable;

    move-result-object v7

    invoke-virtual {p0, v7}, LK2/v;->b(Landroid/graphics/drawable/Drawable;)V
    ...
    iget v8, p0, LK2/v;->v:I

    if-eq v7, v8, :cond_5

    iput v7, p0, LK2/v;->v:I
    ...
    invoke-static {v3}, LU1/a;->m(I)Landroid/widget/ImageView$ScaleType;

    move-result-object v3

    iput-object v3, p0, LK2/v;->w:Landroid/widget/ImageView$ScaleType;
    ...
    invoke-virtual {p2, p1}, Lo3/e;->N(I)Landroid/content/res/ColorStateList;
    ...
    :goto_0
    iput-object v6, p0, LK2/v;->r:Ljava/lang/CharSequence;

    invoke-virtual {v4, p1}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    invoke-virtual {p0}, LK2/v;->e()V
...
.method public final a()I
    ...
    iget-object v0, p0, LK2/v;->s:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    iget-object v2, p0, LK2/v;->q:Lp/G;
...
.method public final b(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object p1, p0, LK2/v;->t:Landroid/content/res/ColorStateList;

    iget-object v1, p0, LK2/v;->u:Landroid/graphics/PorterDuff$Mode;

    iget-object v2, p0, LK2/v;->p:Lcom/google/android/material/textfield/TextInputLayout;
    ...
    invoke-virtual {p0, p1}, LK2/v;->c(Z)V

    iget-object p1, p0, LK2/v;->t:Landroid/content/res/ColorStateList;

    invoke-static {v2, v0, p1}, LU1/a;->H(Lcom/google/android/material/textfield/TextInputLayout;Lcom/google/android/material/internal/CheckableImageButton;Landroid/content/res/ColorStateList;)V
    ...
    iget-object p1, p0, LK2/v;->x:Landroid/view/View$OnLongClickListener;
    ...
    iput-object v1, p0, LK2/v;->x:Landroid/view/View$OnLongClickListener;
...
.method public final d()V
    ...
    iget-object v0, p0, LK2/v;->p:Lcom/google/android/material/textfield/TextInputLayout;
    ...
    :cond_0
    iget-object v1, p0, LK2/v;->s:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    iget-object v4, p0, LK2/v;->q:Lp/G;
...
.method public final e()V
    ...
    iget-object v0, p0, LK2/v;->r:Ljava/lang/CharSequence;
    ...
    :goto_0
    iget-object v3, p0, LK2/v;->s:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    iget-object v1, p0, LK2/v;->q:Lp/G;
