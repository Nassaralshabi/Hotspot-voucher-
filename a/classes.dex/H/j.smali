...
.method public static H(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    ...
    invoke-static {v0, v1}, LH/j;->J(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    invoke-static {v0, v4}, LH/j;->J(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
.method public static I([LN/i;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 8
    ...
    :try_start_0
    iget-object v5, v4, LN/i;->a:Landroid/net/Uri;
...
.method public final f(Landroid/content/Context;LG/f;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    iget-object v3, v3, LG/g;->d:Ljava/lang/String;
    ...
    invoke-static {p2, p4}, LH/j;->H(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final g(Landroid/content/Context;[LN/i;I)Landroid/graphics/Typeface;
    ...
    :try_start_0
    invoke-static {p2, p1}, LH/j;->I([LN/i;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-static {p1, p3}, LH/j;->H(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final h(Landroid/content/Context;Ljava/util/List;I)Landroid/graphics/Typeface;
    ...
    invoke-static {v0, p1}, LH/j;->I([LN/i;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-static {v4, p1}, LH/j;->I([LN/i;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    :cond_2
    invoke-static {v0, p3}, LH/j;->H(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final n([LN/i;I)LN/i;
    .locals 0
