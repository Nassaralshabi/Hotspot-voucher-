...
.method public a(ILandroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p2}, LS1/b;->d(Landroid/content/Context;)Z
    ...
    :try_start_0
    invoke-static {p2}, LU1/c;->a(Landroid/content/Context;)LU1/b;
    ...
    invoke-virtual {p3, p2, v0}, LU1/b;->b(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
...
.method public b(Landroid/content/Context;I)I
    ...
    sget-object v0, LK1/i;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_0
    sget-object v0, LN1/C;->a:Ljava/lang/Object;

    monitor-enter v0

    :try_start_1
    sget-boolean v2, LN1/C;->b:Z
    ...
    :try_start_2
    invoke-virtual {v3, v2, v4}, LU1/b;->a(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_5
    :goto_4
    invoke-static {p1}, LS1/b;->d(Landroid/content/Context;)Z
    ...
    sget-object v0, LS1/b;->e:Ljava/lang/Boolean;
    ...
    sput-object v0, LS1/b;->e:Ljava/lang/Boolean;
    ...
    invoke-static {p1}, LK1/j;->a(Landroid/content/Context;)LK1/j;

    invoke-static {v7, v1}, LK1/j;->f(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {v6, v1}, LK1/j;->f(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {p1}, LK1/i;->b(Landroid/content/Context;)Z
