...
.field public m0:Lcom/google/android/material/datepicker/o;
...
.method public final B(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Lcom/google/android/material/datepicker/k;->m0:Lcom/google/android/material/datepicker/o;
...
.method public final L(Lcom/google/android/material/datepicker/o;)V
    .locals 6

    iget-object v0, p0, Lcom/google/android/material/datepicker/k;->q0:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v0}, Landroidx/recyclerview/widget/RecyclerView;->getAdapter()Lw0/w;
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/k;->m0:Lcom/google/android/material/datepicker/o;

    iget-object v0, v0, Lcom/google/android/material/datepicker/s;->c:Lcom/google/android/material/datepicker/b;

    iget-object v0, v0, Lcom/google/android/material/datepicker/b;->p:Lcom/google/android/material/datepicker/o;
    ...
    :cond_1
    iput-object p1, p0, Lcom/google/android/material/datepicker/k;->m0:Lcom/google/android/material/datepicker/o;
    ...
    invoke-direct {v0, v1, v2, p0}, LG4/e;-><init>(IILjava/lang/Object;)V
...
.method public final M(I)V
    ...
    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView;->getLayoutManager()Lw0/D;
    ...
    iget-object v3, p0, Lcom/google/android/material/datepicker/k;->m0:Lcom/google/android/material/datepicker/o;
    ...
    iget v0, v0, Lcom/google/android/material/datepicker/o;->r:I

    sub-int/2addr v3, v0

    invoke-virtual {p1, v3}, Lw0/D;->m0(I)V
    ...
    iget-object p1, p0, Lcom/google/android/material/datepicker/k;->m0:Lcom/google/android/material/datepicker/o;

    invoke-virtual {p0, p1}, Lcom/google/android/material/datepicker/k;->L(Lcom/google/android/material/datepicker/o;)V
...
.method public final v(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-static {v0, v2}, Lcom/google/android/material/datepicker/l;->P(Landroid/content/Context;I)Z
    ...
    sget v8, Lcom/google/android/material/datepicker/p;->s:I
    ...
    invoke-direct {v3, v7}, LT/e;-><init>(I)V

    invoke-static {p2, v3}, LQ/I;->j(Landroid/view/View;LQ/b;)V
    ...
    iget v1, v1, Lcom/google/android/material/datepicker/o;->s:I
    ...
    invoke-virtual {v1, p2}, Landroidx/recyclerview/widget/RecyclerView;->setLayoutManager(Lw0/D;)V
    ...
    invoke-direct {v3, p0, v5}, LI1/i;-><init>(Ljava/lang/Object;I)V

    invoke-direct {p2, v0, v1, v3}, Lcom/google/android/material/datepicker/s;-><init>(Landroid/view/ContextThemeWrapper;Lcom/google/android/material/datepicker/b;LI1/i;)V

    iget-object v1, p0, Lcom/google/android/material/datepicker/k;->q0:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v1, p2}, Landroidx/recyclerview/widget/RecyclerView;->setAdapter(Lw0/w;)V
    ...
    iput-object v5, p0, Lcom/google/android/material/datepicker/k;->p0:Landroidx/recyclerview/widget/RecyclerView;

    if-eqz v5, :cond_2

    invoke-virtual {v5, v4}, Landroidx/recyclerview/widget/RecyclerView;->setHasFixedSize(Z)V

    iget-object v5, p0, Lcom/google/android/material/datepicker/k;->p0:Landroidx/recyclerview/widget/RecyclerView;

    new-instance v6, Landroidx/recyclerview/widget/GridLayoutManager;

    invoke-direct {v6, v1}, Landroidx/recyclerview/widget/GridLayoutManager;-><init>(I)V

    invoke-virtual {v5, v6}, Landroidx/recyclerview/widget/RecyclerView;->setLayoutManager(Lw0/D;)V
    ...
    invoke-virtual {v1, v5}, Landroidx/recyclerview/widget/RecyclerView;->setAdapter(Lw0/w;)V
    ...
    invoke-virtual {v1, v5}, Landroidx/recyclerview/widget/RecyclerView;->f(Lw0/B;)V
    ...
    invoke-direct {v5, p0, v6}, LC2/a;-><init>(Ljava/lang/Object;I)V

    invoke-static {v1, v5}, LQ/I;->j(Landroid/view/View;LQ/b;)V
    ...
    iput-object v5, p0, Lcom/google/android/material/datepicker/k;->r0:Landroid/view/View;
    ...
    iput-object v5, p0, Lcom/google/android/material/datepicker/k;->s0:Landroid/view/View;
    ...
    invoke-virtual {v3, v4}, Landroidx/recyclerview/widget/RecyclerView;->g(Lw0/G;)V
    ...
    iget-object v2, v0, Lw0/u;->a:Landroidx/recyclerview/widget/RecyclerView;
    ...
    :cond_4
    iget-object v3, v0, Lw0/u;->b:Lw0/V;

    if-eqz v2, :cond_6

    iget-object v2, v2, Landroidx/recyclerview/widget/RecyclerView;->t0:Ljava/util/ArrayList;
    ...
    invoke-virtual {v2, v4}, Landroidx/recyclerview/widget/RecyclerView;->setOnFlingListener(Lw0/F;)V

    :cond_6
    iput-object v1, v0, Lw0/u;->a:Landroidx/recyclerview/widget/RecyclerView;

    if-eqz v1, :cond_8

    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView;->getOnFlingListener()Lw0/F;

    move-result-object v1

    if-nez v1, :cond_7

    iget-object v1, v0, Lw0/u;->a:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v1, v3}, Landroidx/recyclerview/widget/RecyclerView;->g(Lw0/G;)V

    iget-object v1, v0, Lw0/u;->a:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v1, v0}, Landroidx/recyclerview/widget/RecyclerView;->setOnFlingListener(Lw0/F;)V
    ...
    iget-object p2, p2, Lcom/google/android/material/datepicker/b;->p:Lcom/google/android/material/datepicker/o;
